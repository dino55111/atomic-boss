const { initDb, createEvent, updateEventThreadId, updateEventThreadMessageId, addSignup } = require('../src/db/db');
const {
...
describe('handleCancelButton', () => {
  test('removes an existing signup, edits the announcement embed and thread control buttons, and posts to the thread', async () => {
